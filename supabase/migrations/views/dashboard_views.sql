-- Dashboard Views
-- Views for financial dashboard functionality

-- ===========================================
-- EXPENSES WITH CATEGORIES VIEW
-- ===========================================

-- Drop existing view if it exists
DROP VIEW IF EXISTS public.expenses_with_categories;

-- Create view for expenses with category information
...
-- ===========================================
-- BUDGETS WITH CATEGORIES VIEW
-- ===========================================

-- Drop existing view if it exists
DROP VIEW IF EXISTS public.budgets_with_categories;

-- Create view for budgets with category information
...
-- ===========================================
-- SPENDING ALERTS WITH CATEGORIES VIEW
-- ===========================================

-- Drop existing view if it exists
DROP VIEW IF EXISTS public.alerts_with_categories;

-- Create view for spending alerts with category information
